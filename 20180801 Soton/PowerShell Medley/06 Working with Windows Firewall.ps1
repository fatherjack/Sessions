...
get-NetFirewallProfile | ogv

# checking what rules are created
Get-NetFirewallRule | ogv
...
Get-NetFirewallPortFilter | Where-Object LocalPort -Match 50999

# and then use the CreationClassName to identify FW rules that are active on our chosen port
$RulesWithPort = Get-NetFirewallPortFilter | Where-Object LocalPort -Match 50999
